...
/********************************高电平刹车功能测试开始***********************************/
    ...
    Gpio_WriteOutputIO(GpioPortB, GpioPin1, TRUE);                    //PB01输出高-->PB11,使能Port brake，PWM输出指定的电平(低电平)
...
/********************************低电平刹车功能测试开始***********************************/
    ...
    Gpio_WriteOutputIO(GpioPortB, GpioPin1, FALSE);                   //PB01输出低-->PB11,使能Port brake，PWM输出指定的电平(低电平)
